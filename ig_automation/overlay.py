...
#
# Плюс: сетка профиля IG кропает 9:16-превью примерно до 4:5 по центру — то есть
# обрезает ~285px сверху и снизу от 1920. 210px оказалось МАЛО — вордмарк резало
# по границе (2026-07-19). Подняли до 340 — запас ниже границы кропа.
_TOP_Y_BY_RATIO = {"9:16": 340}       # y вордмарка POWERELIX; дефолт 60
