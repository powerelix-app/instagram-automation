...
text_slide(f"{OUT}/05.png", "Что помогает выровнять баланс:", bullets=[
    "Сон по режиму",
    "Меньше сахара",
    "Движение и воздух",
...
text_slide(f"{OUT}/07.png", "Хочешь меньше качелей?",
           note="Инозитол POWERELIX мягко поддержит твой гормональный баланс — "
                "и качелей станет меньше, а настроение ровнее. Ищи по ссылке в профиле.\n"
